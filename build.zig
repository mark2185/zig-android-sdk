...
/// Deprecated: Use Sdk.KeyToolOptions instead.
pub const CreateKey = @compileError("Use android.Sdk.KeyToolOptions instead of android.CreateKey. Change 'android_tools.createKeyStore(android.CreateKey.example())' to 'android_sdk.createKeyStore(.debug)'");
